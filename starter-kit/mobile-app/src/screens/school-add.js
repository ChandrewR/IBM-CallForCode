...
import { add, userID } from '../lib/school-utils'
...
const AddResource = function ({ navigation }) {
  const clearItem = { userID: userID(), type: 'School', name: '', rollno: '', school: '', district: '', state: '', country: '', location: '', contact: '', scholarshipamount: '0' }
  ...
  const sendItem = () => {
    ...
    const payload = {
      ...item,
      scholarshipamount: isNaN(item.scholarshipamount) ? 0 : parseInt(item.scholarshipamount)
  ...
  return (
    <ScrollView style={styles.outerView}>
      <View style={styles.splitView}>
        ...
        <View style={styles.quantityArea}>
          ...
          <TextInput
            ...
            value={item.rollno}
            onChangeText={(t) => setItem({ ...item, rollno: t })}
      ...
      <TextInput
        style={styles.textInput}
        value={item.school}
        onChangeText={(t) => setItem({ ...item, school: t })}
        onSubmitEditing={sendItem}
        returnKeyType='send'
        enablesReturnKeyAutomatically={true}
