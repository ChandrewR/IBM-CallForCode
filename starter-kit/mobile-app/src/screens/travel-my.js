...
import { search, userID } from '../lib/travel-utils'
  ...
  const Item = (props) => {
    return (
      <TouchableOpacity style={styles.itemTouchable}
        onPress={() => { navigation.navigate('Edit Travel', { item: props }); }}>
        <View style={styles.itemView}>
          <Text style={styles.itemName}>{props.district + ',' + props.state + ',' + props.country}</Text>
          <Text style={styles.itemQuantity}> ( {props.currentcoronacount} ) </Text>
        </View>
